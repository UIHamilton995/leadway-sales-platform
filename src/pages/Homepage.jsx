...
const DashboardHeader = ({ username }) => {
  return (
    <div className="flex justify-between items-center mb-2">
      ...
      <button className="bg-rose-500 hover:bg-rose-600 text-white px-4 py-2 rounded-lg flex items-center">
...
const StatsCardsAndChart = () => {
  ...
  return (
    <div className="grid grid-cols-6 gap-2 mb-4">
      ...
      <div className="col-span-3 bg-white rounded-lg p-3 shadow-sm">
        <div className="flex justify-between items-center mb-2">
...
const DashboardPage = () => {
  return (
    <div className="p-6 max-w-screen-2xl mx-auto">
      <DashboardHeader username="Favour" />
      <StatsCardsAndChart />
      <ReportHistoryTable />
    </div>
  );
